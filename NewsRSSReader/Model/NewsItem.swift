...
//  NewsRSSReader
//
//  Created by Andrey Simakov on 28.09.2024.
//
import Foundation
import FeedKit
...
struct NewsItem: Identifiable {
    ...
    init(title: String?, summary: String?, authors: [String]?, link: String?, updated: Date?, categories: [String]?, content: String?, published: Date?, source: String?, rights: String?, image: String?) {
        self.title = title
